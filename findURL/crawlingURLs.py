...
#tocrawl         crawled
#['.../index.html] []
# add index to drawled ['.../index.html]
# add to crall then add to crawled.
# pop from tocrawl add to crawled.
# add to tocrawl.append add to crawles.
...
#return crawled
#detpth - first search, follow last link,
#add links to page, follow last link, add links
#test if page was crawled.
...
def crawl_web(seed):
    ...
    while tocrawl:
        ...
        if page not in crawled:
            ...
            #print union(tocrawl,get_all_links(get_page(page)))
            #print get_all_links(get_page(page))
            print tocrawl
            page = crawled.append(page)
            #print tocrawl
            #return tocrawl
    return crawled


startPage = "http://xkcd.com/353"
 
print crawl_web(startPage)


startPage = "http://xkcd.com/554"
